...
public class Cage : MonoBehaviour
{
    ...
    private void Start()
    {
        isClear = DataManager.Instance.isPuzzleCleard[GameManager.Instance.CurrentStage - 2];
        PuzzleClear = Open;
        if (isClear)
            Open();
    }
    ...
    {
        Debug.Log("¼º°ø");
        DataManager.Instance.isPuzzleCleard[GameManager.Instance.CurrentStage - 2] = true;
        isClear = true;
