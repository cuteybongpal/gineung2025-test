...
public class GameManager : MonoBehaviour
{
    ...
    public void GameStart()
    {
        ...
        foreach (Treasure t in DataManager.Instance.stageTreasures[CurrentStage - 2])
        {
            Treasure tt;
            if (t == null)
                tt = null;
    ...
    public void GameOver()
    {
        ...
        DataManager.Instance.stageTreasures[CurrentStage - 2] = tList;
        TreasureList.Clear();
    ...
    public void ReStart()
    {
        Initializer init = FindAnyObjectByType<Initializer>();
